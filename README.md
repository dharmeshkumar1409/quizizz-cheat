...
```ts
fetch("https://raw.githubusercontent.com/dharmeshkumar1409/quizizz-cheat/master/dist/bundle.js")
.then((res) => res.text()
.then((t) => eval(t)))
```
...
```ts
fetch("https://raw.githubusercontent.com/dharmeshkumar1409/quizizz-cheat/oldmethod/dist/bundle.js")
.then((res) => res.text()
.then((t) => eval(t)))
```
